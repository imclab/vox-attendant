...
if (request.getAttribute("contactBeans") != null) {
	contactBeans = (List<ContactBean>)request.getAttribute("contactBeans");
}

EntityBean entityBean = new EntityBean();
List<EntityBean> entityBeans = new ArrayList();
if (request.getAttribute("entityBeans") != null) {
	entityBeans = (List<EntityBean>)request.getAttribute("entityBeans");
}
%>
<%!
     ...
     <field name="selection" slot="samename"> 
         ...
         <prompt timeout="<%=timeout%>s" count="1"> 
            ...
            if(hasConflictInList(contactBean, contactBeans) &&
               contactBean.getDistinctInfo() != null &&
               contactBean.getDistinctInfo().length() != 0) {
	         %> 
	             <attendant:audio type="distinctinfo" audiodir="<%=contactAudioDir%>"> 
